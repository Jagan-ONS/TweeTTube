...
const getUserChannelProfile = asyncHandler(async(req,res)=>{
    //when we what the details of a channel we willl go to that channel
    //we will get the user from url ie params 
...
const getWatchHistory = asyncHandler( async(req,res) => {
    const user = await User.aggregate([
        ...
        {
            $lookup : {
                from : "videos",//actually Video it will be converted in videos by mongoose
